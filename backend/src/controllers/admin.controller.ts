...
export const getDashboardStats = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get dashboard stats error: ${getErrorMessage(error)}`);
...
export const getPassengers = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get passengers error: ${getErrorMessage(error)}`);
...
export const getPassengerById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get passenger error: ${getErrorMessage(error)}`);
...
export const updatePassenger = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Update passenger error: ${getErrorMessage(error)}`);
...
export const togglePassengerActive = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    // Passenger is populated with user data
    const passengerDoc = passenger as { user?: { isActive?: boolean } };
    const isActive = passengerDoc.user?.isActive ?? true;
    ...
    logger.error(`Toggle passenger error: ${getErrorMessage(error)}`);
...
export const getDrivers = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get drivers error: ${getErrorMessage(error)}`);
...
export const getDriverById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get driver error: ${getErrorMessage(error)}`);
...
export const getPendingDrivers = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get pending drivers error: ${getErrorMessage(error)}`);
...
export const approveDriver = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Approve driver error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const rejectDriver = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Reject driver error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const suspendDriver = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Suspend driver error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const activateDriver = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Activate driver error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const getTrips = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get trips error: ${getErrorMessage(error)}`);
...
export const getTripById = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get trip error: ${getErrorMessage(error)}`);
...
export const getTripStats = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get trip stats error: ${getErrorMessage(error)}`);
...
export const getRecentTrips = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get recent trips error: ${getErrorMessage(error)}`);
...
export const getFinanceStats = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get finance stats error: ${getErrorMessage(error)}`);
...
export const getRevenueChart = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get revenue chart error: ${getErrorMessage(error)}`);
...
export const getFareSettings = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get fare settings error: ${getErrorMessage(error)}`);
...
export const updateFareSetting = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Update fare setting error: ${getErrorMessage(error)}`);
...
export const createFareSetting = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Create fare setting error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const getZones = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Get zones error: ${getErrorMessage(error)}`);
...
export const updateZone = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Update zone error: ${getErrorMessage(error)}`);
...
export const createZone = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Create zone error: ${getErrorMessage(error)}`);
    sendBadRequest(res, getErrorMessage(error), getErrorMessage(error));
  }
};
...
export const deleteZone = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    logger.error(`Delete zone error: ${getErrorMessage(error)}`);
