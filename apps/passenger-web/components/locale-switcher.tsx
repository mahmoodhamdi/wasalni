...
/**
 * Simple two-locale flip (AR ↔ EN). Rewrites the current pathname to the
 * other locale and refreshes server components.
 */
export function LocaleSwitcher(): React.ReactElement {
  ...
  const handleClick = React.useCallback(() => {
    // pathname always starts with /<locale>, swap the segment in place.
