...
/// Location picker screen using map
...
class _LocationPickerScreenState extends State<LocationPickerScreen> {
  ...
  final bool _isLoadingAddress = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Map placeholder - to be replaced with actual WasalniMap
          Container(
