            ...
            children: [
              ...
              Center(
                child: _canResend
                    ...
                    : Text('إعادة الإرسال خلال $_resendSeconds ثانية', style: AppTextStyles.caption),
              ),
              const Spacer(),
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
                  onPressed: _isLoading || _otp.length != AppConfig.otpLength ? null : _verifyOTP,
                  child: _isLoading
                      ? SizedBox(
                          width: 24.w,
                          height: 24.w,
                      ...
                      : Text('تحقق', style: AppTextStyles.button.copyWith(color: Colors.white)),
                ),
              ),
              SizedBox(height: 24.h),
            ],
